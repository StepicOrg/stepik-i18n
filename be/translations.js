export default {
    ...
    "announcement_ _ default-template": "Стандартны шаблон",
    "attachments__list-attach-file": "Далучыць файл",
    "attachments__list-delete-attachment-tooltip": "Выдаліць",
    "attachments _ _ list-open-attachment-tooltip": "Адкрыць",
    "attachments _ _ list-title": "Файлы",
    "attachments _ _ list-too-big-file-warn": "Максімальны памер файла: {{max_size}}.",
    "ARIA": {
        "nav": {
    ...
    "breadcrumbs_ _ certificate-edit": "Сертыфікат",
    "breadcrumbs_ _ course-edit": "Рэдагаванне",
    "breadcrumbs _ _ course-permissions-edit": "Налады доступу да курсу",
    "breadcrumbs _ _ course-lti-edit": "Інтэграцыя па LTI",
    "breadcrumbs_ _ course-grade-book": "Адзнакі",
    "breadcrumbs_ _ course-reports": "Справаздачы",
    "breadcrumbs _ _ course-statistics": "Статыстыка",
    "breadcrumbs _ _ course-syllabus": "Расклад",
    ...
    "breadcrumbs_ _ notifications-my": "Мае падзеі",
    "breadcrumbs_ _ notifications-new": "Новыя апавяшчэнні",
    "breadcrumbs__review": "Рэцэнзаванне",
    "breadcrumbs _ _ review-session": "Рэцэнзіі",
    "breadcrumbs_ _ submissions": "Рашэнні",
    "button_ _ new-course": "Стварыць курс",
    ...
    "certificate _ _ download": "Спампаваць сертыфікат",
    "course-filters": {
        "tags": "Прадметы",
        "langs": "Мова курсу",
        "categories": "Катэгорыі"
    },
    "comments _ _ abuse": "Не падабаецца",
    "comments _ _ abuse-tooltip": "Адзначыць каментар як не ўпадабаны",
    "comments _ _ active-order": "Часта абмяркоўваюцца",
    "comments _ _ auth-warn": "Каб далучыцца да гэтага абмеркавання вам трэба",
    "comments _ _ by-date-order": "Новыя абмеркаванні",
    "comments_ _ choose-submission": "Прымацаваць рашэнне",
    "comments _ _ default-order": "Самыя папулярныя",
    "comments _ _ delete": "Выдаліць",
    "comments _ _ delete-error": "Памылка выдалення каментара",
    "comments _ _ delete-tooltip": "Выдаліць гэты каментар",
    "comments_ _ deleted-by": "Выдалена",
    "comments _ _ deleted-by-user": "Карыстальнікам",
    "comments _ _ edit": "Рэдагаваць",
    "comments _ _ edit-tooltip": "Рэдагаваць гэты каментар",
    "comments _ _ edited": "Зменены",
    "comments_ _ discussion-link": "Спасылка на гэта абмеркаванне",
    "comments_ _ empty-disc-warn": "Ваш каментар пусты",
    "comments__gradebook": "Адзнакі",
    "comments _ _ gradebook-tooltip": "Адзнакі аўтара каментара за гэты курс",
    "comments_ _ load": "Паказаць абмеркаванні",
    "comments_ _ load-replies": "Паказаць больш адказаў",
    "comments_ _ moderator-badge": "Мадэратар курсу",
    "comments__network-error": "Штосьці пайшло не так. Абнавіце старонку, каб убачыць каментары.",
    "comments _ _ not-found": "Каментар # {{comment_id}} выдалены ці ніколі не існаваў",
    "comments_ _ pin": "Замацаваць",
    "comments_ _ pin-tooltip": "Паказваць гэты каментар вышэй за іншых",
    "comments_ _ pinned": "Замацавана",
    "comments _ _ pinned-tooltip": "Гэты каментар замацаваны (заўсёды паказваецца перад іншымі)",
    "comments _ _ post-reply": "Адправіць адказ",
    "comments_ _ recent-order": "Свежыя абнаўленні",
    "comments_ _ replies-hide": "Схаваць адказы",
    "comments__replies-show": "Паглядзець адказы",
    "comments_ _ replies-toggle-tooltip": "Паказаць / схаваць адказы да каментароў",
    "comments__reply": "Адказаць",
    "comments _ _ reply-link": "Спасылка на гэты каментар",
    "comments_ _ reply-tooltip": "Адказаць на гэты каментар",
    "comments _ _ solutions-thread-permisison-error": "У вас няма доступу да дадзенага каментара. Вырашыце дадзеную задачу, каб атрымаць доступ да форуму рашэнняў",
    "comments_ _ staff-badge": "Каманда Stepik",
    "comments_ _ staff-replied":", адказ выкладчыка",
    "comments_ _ submissions": "Рашэнні",
    "comments_ _ submissions-tooltip": "Рашэнні аўтара каментара",
    "comments_ _ submit-error": "Не атрымалася адправіць ваш каментар =(",
    "comments_ _ teacher-badge": "Каманда курсу",
    "comments _ _ thread-default": "Каментары",
    "comments_ _ thread-solutions": "Рашэнні",
    "comments_ _ unpin": "Адмацаваць",
    "comments _ _ unpin-tooltip": "Каказваць гэты каментар у звычайным парадку (не перад іншымі)",
    "common": {
    ...
    "common _ _ certificate": "Сертыфікат",
    "common_ _ certificate-distinction": "Сертыфікат з адзнакай",
    "common__certificate-атрымальнік": "Атрымальнік",
    "common _ _ challenge": "Складаная задача",
    "common _ _ close": "Закрыць",
    "common__close-window": "Закрыць вакно",
    "common_ _ cookies-warn": "Ваш браўзер не падтрымлівае cookies. Калі ласка, < a data-outward=true target=\ " _blank\"href=\" https://yandex.ru/support/common/browsers-settings/browsers-cookies.xml \ " >уключыце < / a> cookies у наладах вашага браўзэра.",
    "common__course": "Курс",
    "common__course-logo": "Лагатып курсу",
    "common _ _ catalog": "Каталог",
    "common__my-courses": "Мае курсы",
    "common__delete-failed-warn": "Не атрымалася выдаліць.",
    "common _ _ download-video": "Спампаваць відэа",
    "common _ _ edit": "Рэдагаваць",
    "common _ _ error-loading": "[{{resource_name}}] Памылка загрузкі!",
    "common_ _ experimental": "Эксперыментальна",
    "common__feedback": "Паказаць цалкам",
    "common _ _ feedback-hide": "Згарнуць",
    "common_ _ fixed": "Адзначыць выпраўленым",
    "common_ _ fullscreen": "Поўнаэкранны рэжым",
    "common__hard-deadline": "Жорсткі дэдлайн",
    "common_ _ input-length-warn.few": "Мінімум {{count}} сімвала",
   "common_ _ input-length-warn.many": "Мінімум {{count}} сімвалаў",
    "common_ _ input-length-warn.one": "Мінімум {{count}} сімвал",
    "common_ _ input-length-warn.other": "Мінімум {{count}} сімвала",
    "common__knowledge": "Веды",
    "common__lesson": "Урок",
    "common_ _ lessons": "Урокі",
    "common _ _ lesson-image": "Малюнак уроку",
    ...
    "common__min": "хвіл",
    "common__hour": "гадз",
    "common _ _ notifications": "Апавяшчэнні",
    "common _ _ platform-news": "Што новага",
    "common__number-sign":" №",
    "common _ _ off": "выкл.",
    "common _ _ points": {
        "one": "{{count}} бал",
